...
function AuthFormInner() {
  ...
  // the single authoritative gate: it shows the form for users who have not
  // chosen a display name yet and immediately redirects everyone else on to
  // `callbackURL`. Routing all methods through one server-side gate avoids the
  // client/server disagreement that previously caused the screen to flicker
  // and the sign-up step to be skipped.
  const onboardingDest = displayNameOnboardingPath(callbackURL)
          ...
          <>
            <div className="space-y-3">
              <SocialButton
                ...
                newUserCallbackURL={onboardingDest}
                icon={
