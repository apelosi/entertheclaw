...
/** In-world date for every stage's opening scene (scene_change + columns). */
const OPENING_SCENE_AT = new Date('2016-05-22T12:00:00.000Z')
...
const SCENES: SceneSeed[] = [
  {
    ...
    initialSceneName: 'The Oracle’s steps at Delphi, dawn, May 22, 2016',
  ...
  {
    name: 'Game of Claws',
    initialSceneName: 'Great Hall of the keep, late afternoon, May 22, 2016',
    initialSceneDescription:
  ...
  {
    name: 'Clawaway',
    initialSceneName: 'Wreckage beach, mid-morning, May 22, 2016',
    initialSceneDescription:
  ...
  {
    name: 'Claw Wars',
    initialSceneName: 'Smuggler’s cantina on a frontier moon, May 22, 2016',
    initialSceneDescription:
  ...
  },
  {
    ...
    initialSceneName: 'Sun-bleached saloon, mid-afternoon, May 22, 2016',
    initialSceneDescription:
  ...
  {
    name: 'Crablet',
    initialSceneName: 'Battlements of Elsinore, midnight, May 22, 2016',
    initialSceneDescription:
  ...
  {
    name: 'Hail Crabby',
    initialSceneName: 'NASA briefing room, 0400, May 22, 2016',
    initialSceneDescription:
  ...
  {
    name: 'Enter the Claw',
    initialSceneName: 'Mountaintop temple courtyard, sunrise, May 22, 2016',
    initialSceneDescription:
  ...
  {
    name: 'Claws',
    initialSceneName: 'Amity town hall, emergency meeting, May 22, 2016',
    initialSceneDescription:
  ...
  {
    name: 'Crabcula',
    initialSceneName: 'Carpathian inn, the last fire of evening, May 22, 2016',
    initialSceneDescription:
  ...
  {
    name: 'House of Claws',
    initialSceneName: 'Capitol corridor outside the whip’s office, May 22, 2016',
    initialSceneDescription:
  ...
  {
    name: 'Ragnaclaws',
    initialSceneName: 'Mead-hall of the Aesir, winter feast, May 22, 2016',
    initialSceneDescription:
  ...
  {
    name: 'Clawpatra',
    initialSceneName: 'Throne room of Alexandria, audience hour, May 22, 2016',
    initialSceneDescription:
  ...
  {
    name: 'Moneycrabs',
    initialSceneName: 'GM’s office, spring training, May 22, 2016',
    initialSceneDescription:
  ...
  {
    name: 'Shell Game',
    initialSceneName: 'Bellagio suite, the crew assembles, May 22, 2016',
    initialSceneDescription:
  ...
  },
  {
    ...
    initialSceneName: 'MI6 briefing room, no daylight, May 22, 2016',
    initialSceneDescription:
  ...
  },
  {
    ...
    initialSceneName: 'Shawshank prison yard, exercise hour, May 22, 2016',
    initialSceneDescription:
  ...
  },
  {
    ...
    initialSceneName: 'JAG office, dawn before trial, May 22, 2016',
    initialSceneDescription:
  ...
  {
    name: 'The Claw Games',
    initialSceneName: 'District 12 town square, Reaping Day, May 22, 2016',
    initialSceneDescription:
...
async function main() {
  ...
  console.log(`\nSyncing opening scene_change rows (name, description, date)…`)

  let openingsSynced = 0
  for (const s of SCENES) {
    ...
    await db
      ...
      .set({
        ...
        content: {
          name: s.initialSceneName,
          description: s.initialSceneDescription,
          reason: 'Opening scene',
        },
      })
      .where(eq(stageEvents.id, opening.id))

    console.log(`  ✓ ${s.name} — opening scene_change synced`)
    openingsSynced++
  }
  ...
  console.log(`  Opening scene_change rows synced: ${openingsSynced}`)
